    ...
    routes: [
        ...
        },
        {
            ...
            props: (route) => ({
                ...
                forcePronomial:
                    route.query.fp !== undefined && route.query.fp !== "0"
                        ? "1"
                        : "0",
            }),
        },
        ...
        },
        {
            ...
            beforeEnter(to) {
                ...
                if (Object.hasOwn(decoded, "fm") && decoded.fm === 1)
                    temp.push("fm");
                if (Object.hasOwn(decoded, "fp") && decoded.fp === 1)
                    temp.push("fp");
                ...
                chosenPronounRadio1.value = Object.hasOwn(decoded, "prRad1")
                    ? decoded.prRad1
                    : "";
                chosenPronounRadio2.value = Object.hasOwn(decoded, "prRad2")
                    ? decoded.prRad2
                    : "0";
                chosenTenseRadio.value = Object.hasOwn(decoded, "tnRad")
                    ? decoded.tnRad
                    : "";
                if (Object.hasOwn(decoded, "tnCh")) {
                    switch (decoded.tnRad) {
                        case "tn-v":
                            chosenTenseChecks.value = verbathonTenses;
                            break;
                        case "tn-a":
                            chosenTenseChecks.value = allTensesIdList;
                            break;
                        case "tn-R":
                            chosenTenseChecks.value = allButRareTensesIdList;
                            break;
                        case "tn-s":
                            chosenTenseChecks.value = decoded.tnCh.map(
                                (x) =>
                                    tenseCheckList.find((y) => y.shortId === x)
                                        .id,
                            );
                            break;
                        default:
        ...
        },
        {
            path: "/help",
            name: "help-home",
            component: () => import("@/views/HelpHomeView.vue"),
        },
        {
            path: "/admin",
            name: "admin-home",
