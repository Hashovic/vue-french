...
<template>
  <button @click.prevent="copyAndAnimate" type="button" class="appearance-none p-2 bg-transparent cursor-pointer rounded-lg border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-700">
